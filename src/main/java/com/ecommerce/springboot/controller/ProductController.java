...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProducts(
            ...
            @RequestParam(name = "sortOrder", defaultValue = AppConstants.SORTING_ORDER) String sortOrder
    ) {
    ...
    public ResponseEntity<ProductResponse> getProductsByCategory(@PathVariable Long categoryId,
                                                                 ...
                                                                 @RequestParam(name = "sortBy", defaultValue = AppConstants.SORT_PRODUCTS_BY) String sortBy,
                                                                 @RequestParam(name = "sortOrder", defaultValue = AppConstants.SORTING_ORDER) String sortOrder) {
        ProductResponse productResponse = productService.searchByCategory(categoryId, pageNumber, pageSize, sortBy, sortOrder); // returns multiple products so not DTO
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }
