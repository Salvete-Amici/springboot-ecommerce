...
public class CategoryServiceImpl implements CategoryService{
    ...
    public CategoryResponse getAllCategories(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if (categories.isEmpty()) {
            throw new APIException("No category created yet"); // validate categories
        }
        List<CategoryDTO> categoryDTOs = categories.stream()
                .map(category -> modelMapper.map(category, CategoryDTO.class))
                .toList(); // we use Model Mapper to map every Category object to CategoryDTO
    ...
    public CategoryDTO createCategory(CategoryDTO categoryDTO) {
        ...
        System.out.println("Saved Category ID: " + savedCategory.getCategoryId());///////
